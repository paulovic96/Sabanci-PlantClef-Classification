...
_FILE_PATTERN_Training = 'test_data_2016_%s_*.tfrecord'

#
SPLITS_TO_SIZES = {'train': 0, 'validation': 0, 'test':8000}
...
def get_split(split_name,dataset_dir, file_pattern=None, reader=None):
  ...
  items_to_handlers = {'image': slim.tfexample_decoder.Image(),'image_id': slim.tfexample_decoder.Tensor('image/class/label')}
